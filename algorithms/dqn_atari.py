...
def _make_base_atari_env(cfg: AtariDQNConfig):
    """
...
def make_atari_env(cfg: AtariDQNConfig):
    print(f"Creating Atari environment {cfg.env_id}.")

    env = _make_base_atari_env(cfg)
